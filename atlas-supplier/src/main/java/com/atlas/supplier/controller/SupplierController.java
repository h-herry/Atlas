 ...
 * @since 1.0.0
 */
@Tag(name = "供应商管理 / Supplier Management", description = "供应商档案的 CRUD、分页查询、状态管理等 / Supplier profile CRUD, pagination, status management")
@RestController
...
public class SupplierController {
    ...
    /** 新增供应商 / Add supplier */
    @Operation(summary = "新增供应商 / Add supplier")
    @PostMapping
    ...
    @AuditLog(module = "SUPPLIER", operation = "UPDATE", description = "更新供应商 / Update supplier")
    ...
    @AuditLog(module = "SUPPLIER", operation = "DELETE", description = "删除供应商 / Delete supplier")
